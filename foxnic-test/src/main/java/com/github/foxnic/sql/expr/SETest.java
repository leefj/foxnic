...
public class SETest {
	...
	public  void se_test_misc() {
		...
		assertTrue("name = :PARAM_1".equals(se1.getNameParameterSQL()));
...
//		//合并两个表达式
		...
		//获得参数Map
		Map<String,Object> mapParams=se3.getNameParameters();
	...
	public void test_long_statement()
	{
		...
		System.out.println(se.getNameParameterSQL());
		System.out.println(se.getNameParameters());
		...
		assertTrue(("INSERT INTO  pms_org_unit_user(unit_code, unit_name,   user_badge, user_id, user_name,user_account) \n" + 
				...
				"LEFT JOIN pms_org_unit o ON  o.unit_code = s.unit_code \n" +
				"where o.is_enabled = 'T' and u.account_enabled = 'T' and s.is_enabled = 'T' and u.badge is not null and u.account is not null \n" + 
				"and (o.unit_code= :PARAM_2 or o.path like :PARAM_3 )").equals(se.getNameParameterSQL()));
		
		assertTrue(se.getNameParameters().size()==3);
