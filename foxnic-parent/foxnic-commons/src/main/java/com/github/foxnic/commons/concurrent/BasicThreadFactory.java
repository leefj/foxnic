...
public class BasicThreadFactory implements ThreadFactory {
    ...
    public static class Builder  {
        ...
        public Builder wrappedFactory(final ThreadFactory factory) {
        	...
        	if(factory==null) {
        		throw new RuntimeException("Wrapped ThreadFactory must not be null!");
        	}
...
//         Validate.notNull(pattern, "Naming pattern must not be null!");
        	...
        	if(pattern==null) {
        		throw new RuntimeException("Naming pattern must not be null!");
        	}
...
//         Validate.notNull(handler, "Uncaught exception handler must not be null!");
            if(handler==null) {
        		throw new RuntimeException("Uncaught exception handler must not be null!");
        	}
