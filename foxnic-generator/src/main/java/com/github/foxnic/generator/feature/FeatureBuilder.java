...
public abstract class FeatureBuilder {
	...
	public static FeatureBuilder[] BUILDERS= {new Insert(),new Delete(),new BatchDelete(),new Update(),new Save(),new GetById() , new QueryList(),new QueryPagedList(),new CheckExists() }; 
